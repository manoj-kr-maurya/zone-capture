...
export namespace Prisma {
  ...
  */
    ...
    model: {
      Runner: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.RunnerFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.RunnerAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface RunnerDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    /**
     * Find zero or more Runners that matches the filter.
     * @param {RunnerFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const runner = await prisma.runner.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
     */
    findRaw(args?: RunnerFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Runner.
     * @param {RunnerAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const runner = await prisma.runner.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: RunnerAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface RunnerFieldRefs {
    ...
    readonly path: FieldRef<"Runner", 'Json'>
   ...
   * Runner findRaw
   */
  export type RunnerFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
   ...
   * Runner aggregateRaw
   */
  export type RunnerAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type RunnerScalarWhereWithAggregatesInput = {
    ...
    path?: JsonWithAggregatesFilter<"Runner">
